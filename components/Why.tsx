        ...
        <div className="dark:bg-primaryBg">
            ...
            <div className="flex flex-col md:flex-row items-center justify-around md:pl-40 pl-2 py-8  ">
                <div className="md:w-1/2 w-full gap-8 flex flex-col">
                    <div>
                        <div className="rounded-full bg-primary w-min p-4"> <WifiIcon height={24} width={24} color="#fff" /></div>
                    ...
                    <div>
                        <div className="rounded-full bg-primary w-min p-4"> <CarIcon height={24} width={24} color="#fff" /></div>
                    ...
                    <div>
                    <div className="rounded-full bg-primary w-min p-4"> <ResortIcon height={24} width={24} color="#fff" /></div>
