...
export const DrinkIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40, color } = props;
...
export const CarIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40, color } = props;
...
export const ResortIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40, color } = props;
